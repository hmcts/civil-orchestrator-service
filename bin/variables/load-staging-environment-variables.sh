...
echo "export CCD_DEFINITION_STORE_API_BASE_URL=https://civil-orch-definition-store-staging.aat.platform.hmcts.net"
echo "export CAMUNDA_BASE_URL=https://civil-orch-camunda-staging.service.aat.platform.hmcts.net"
